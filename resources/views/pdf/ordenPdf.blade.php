...
<head>
    ...
    <style>
      ...
      .table-informacion th, .table-informacion td{
        border: 1px solid gray;
        padding: 3px 3px;
      }
    </style>
...
<body>
  <div class="container-grid">
    <div class="item-orden">
      <img alt="logo" class="navbar-logo" src="{{ public_path('img/centevi.png') }}" style="width:100%; margin-top:-25px" />
    </div>
    <div class="item-orden">
        <h4 style="font-weight:400;font-size:13px; color:#3b3f5c">Fecha de solicitud</h4>
        <button class="item-fecha-orden" style="margin-top:-15px">{{ \Carbon\Carbon::parse($fecha_solicitud)->format('d/m/Y') }}</button>
    </div>
    <div class="item-orden" >
  ...
  @if($lente_contacto)
    <div style="widht: 100%; border: 1px solid blue; border-radius: 25px; padding:20px 20px;  margin-top: 10px">
      ...
      <div style="width:48%;  display: inline-block">
        ...
        <buton class="boton-item-white" style="font-size:12px;white-space: normal; word-wrap: break-word; {{$marca == '_' ? 'color:white':''}}">{{$marca}}</buton>
      </div>
      ...
      <div style="width:48%; display:inline-block;">
        ...
        <button class="boton-item-white" style="font-size:12px; {{$observaciones == '_' ? 'color:white':''}}">{{$observaciones}}</button>
      </div>
    </div>
  @else
    <div style="widht: 100%; border: 1px solid blue; border-radius: 25px; padding:20px 20px;  margin-top: 10px">
      <div style="width:100%; display: inline-block">
        ...
        <div style="width:25%; display: inline-block">
          ...
          <button class="boton-item-white" style="font-size:12px; text-align:left;white-space: normal; word-wrap: break-word; {{$color == '_' ? 'color:white':''}}">{{$color}}</button>
        </div>
      </div>
      <div style="width:100%;  display: inline-block">
        <div style="width:24%; display: inline-block">
          <div style="font-size:12px; display:flex; align-items:center">
            @if($aro_centevi)
              <button style="border-radius:50%; border: 2px solid blue; margin:0 auto; background-color:white; width:5px; height:5px"></button>
            @else
        ...
        <div style="width:24%; display: inline-block">
          ...
          <buton class="boton-item-white" style="font-size:12px;white-space: normal; word-wrap: break-word; {{$codigo == '_' ? 'color:white':''}}">{{$codigo}}</buton>
        </div>
        <div style="width:1%; display:inline-block"></div>
        <div style="width:24%; display: inline-block;">
      ...
      <div style="width:100%; display:inline-block; margin-top:20px;">
        <div style="width:60%; display: inline-block; justify-content:center; position:relative; background-color:red">
          ...
          <button style="position:absolute; left:-25px; border:1px solid red; background-color: white; width:70px; top:72px">{{$l_uno}}</button>
          <button style="position:absolute; left:82px; border:1px solid red; background-color: white; width:70px; top:-2px">{{$l_dos}}</button>
          <button style="position:absolute; left:185px; border:1px solid red; background-color: white; width:70px; top:35px">{{$l_tres}}</button>
          <button style="position:absolute; left:90px; border:1px solid red; background-color: white; width:70px; top:150px">{{$l_cuatro}}</button>
          <button style="position:absolute; left:300px; border:1px solid red; background-color: white; width:70px; top:71px">{{$l_cinco}}</button>
        </div>
        <div style="width:39%; display: inline-block; float:right">
          <div style="width:100%; display: inline-block">
            <div>
              <div style="font-size:12px; color:#888ea8; font-weight:700">TIPO DE ARO*</div>
              <button class="boton-item-white" style="font-size:12px;white-space: normal; word-wrap: break-word;">{{$tipo_aro}}</button>
            </div>
          </div>
