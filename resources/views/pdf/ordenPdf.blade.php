...
<body>
  ...
  @if($lente_contacto)
    <div style="widht: 100%; border: 1px solid blue; border-radius: 25px; padding:20px 20px;  -top: 10px">
      ...
      <div style="width:48%;  display: inline-block">
        ...
        <buton class="boton-item-white" style="font-size:12px">{{$marca}}</buton>
      </div>
      ...
      <div style="width:48%; display:inline-block;">
        ...
        <button class="boton-item-white" style="font-size:12px">{{$observaciones}}</button>
      </div>
    </div>
  @else
    <div style="widht: 100%; border: 1px solid blue; border-radius: 25px; padding:20px 20px;  margin-top: 10px">
      <div style="width:100%; display: inline-block">
        ...
        <div style="width:25%; display: inline-block">
          ...
          <button class="boton-item-white" style="font-size:12px; text-align:left">{{$color}}</button>
        </div>
      </div>
      <div style="width:100%;  display: inline-block">
        ...
        <div style="width:24%; display: inline-block">
          ...
          <buton class="boton-item-white" style="font-size:12px;">{{$codigo}}</buton>
        </div>
        <div style="width:1%; display:inline-block"></div>
        <div style="width:24%; display: inline-block;">
      ...
      <div style="width:100%; display:inline-block; margin-top:20px;">
        <div style="width:60%; display: inline-block; justify-content:center; position:relative; background-color:red">
          ...
          <button style="position:absolute; left:-25px; border:1px solid red; background-color: white; width:70px; top:75px">{{$l_uno}}</button>
          <button style="position:absolute; left:85px; border:1px solid red; background-color: white; width:70px; top:-2px">{{$l_dos}}</button>
          <button style="position:absolute; left:200px; border:1px solid red; background-color: white; width:70px; top:35px">{{$l_tres}}</button>
          <button style="position:absolute; left:85px; border:1px solid red; background-color: white; width:70px; top:155px">{{$l_cuatro}}</button>
          <button style="position:absolute; left:310px; border:1px solid red; background-color: white; width:70px; top:75px">{{$l_cinco}}</button>
        </div>
        <div style="width:39%; display: inline-block; float:right">
          <div style="width:100%; display: inline-block">
            <div>
              <div style="font-size:12px; color:#888ea8; font-weight:700">TIPO DE ARO*</div>
              <button class="boton-item-white" style="font-size:12px">{{$tipo_aro}}</button>
            </div>
          </div>
