...
<head>
    ...
    <style>
        ...
        .detalle-grid.dos-columnas {
            grid-template-columns: 1fr 1fr;
        }

        .detalle-grid.una-columna {
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{
                        ($item['esCentilab'] ?? true)
                            ? ($item['proveedor'] ?? '—')
                            : ($item['detalle']['proveedor_extra'] ?? 'Gestionado por laboratorio')
                    }}
                </td>
                ...
                <td>
                    <div style="font-size:12px; line-height:1.7;">
                        ...
                        <div class="detalle-grid {{ $gridClass }}">
                            ...
                            {{-- Base --}}
                            @if(($item['esCentilab'] ?? true) === false)

                            <span>
                                Nro Base:
                                <strong>{{ $detalle['tipo_base_extra'] ?? 'Gestionado por laboratorio' }}</strong>
                            </span>
