                ...
                <div class="widget-content widget-content-area br-6">
                  ...
                  <div id="zero-config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                    ...
                    <div class="table-responsive">
                      <table id="zero-config" class="table dt-table-hover tablaSucursal dataTable" style="width:100%" role="grid" aria-describedby="zero-config_info">
                        <thead>
                          <tr role="row">
                        ...
                        <tbody>
                          <tr role="row">
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnEditarSucursal" id_sucursal="3" data-toggle="modal" data-target="#modalEditarSucursal">
                                ...
                                <button class="btn btn-danger btnEliminarSucursal" borrar_sucursal="3">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <tr role="row">
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnEditarSucursal" id_sucursal="4" data-toggle="modal" data-target="#modalEditarSucursal">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="modalEditarSucursal" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                  </svg>
                                </button>
                                <button class="btn btn-danger btnEliminarSucursal" borrar_sucursal="4">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                  </svg>
                                </button>
                          ...
                          <tr role="row">
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnEditarSucursal" id_sucursal="5" data-toggle="modal" data-target="#modalEditarSucursal">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="modalEditarSucursal" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                  </svg>
                                </button>
                          ...
                          <tr role="row">
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnEditarSucursal" id_sucursal="7" data-toggle="modal" data-target="#modalEditarSucursal">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="modalEditarSucursal" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                  </svg>
                                </button>
                                <button class="btn btn-danger btnEliminarSucursal" borrar_sucursal="7">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                  </svg>
                                </button>
                          ...
                          <tr role="row">
                            ...
                            <td>
                              <div class="btn-group">
                                <button class="btn btn-warning btnEditarSucursal" id_sucursal="8" data-toggle="modal" data-target="#modalEditarSucursal">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="modalEditarSucursal" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                  </svg>
                                </button>
                                <button class="btn btn-danger btnEliminarSucursal" borrar_sucursal="8">
                                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                  </svg>
                                </button>
                    ...
                    <div class="dt--bottom-section d-sm-flex justify-content-sm-between text-center">
                      <div class="dt--pages-count  mb-sm-0 mb-3">
                        <div class="dataTables_info" id="zero-config_info" role="status" aria-live="polite"></div>
                      </div>
                      <div class="dt--pagination">
                        <div class="dataTables_paginate paging_simple_numbers" id="zero-config_paginate"></div>
                      </div>
                    </div>
                  </div>
                </div>
