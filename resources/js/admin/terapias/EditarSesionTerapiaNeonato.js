...
import { fetchSesionTerapiaNeonato } from '../../redux/features/terapias/VerSesionTerapiaNeonatoSlice.js';
import { fetchSucursales } from '../../redux/features/sucursales/sucursalesSlice.js';
import { editarSesionTerapiaNeonato } from '../../redux/features/terapias/EditarSesionTerapiaNeonatoSlice.js';
import { useParams, useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2';


const EditarSesionTerapiaNeonato = () => {
    ...
    const { status: editStatus, error: editError } = useSelector((state) => state.editarSesionTerapiaNeonato);
    ...
    const handleSubmit = (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(editarSesionTerapiaNeonato({
                    id_sesion,
...
export default EditarSesionTerapiaNeonato