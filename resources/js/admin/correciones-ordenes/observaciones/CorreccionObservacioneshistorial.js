...
const CorreccionObservacionesHistorial = ({
  ...
  const { correccionesObservaciones } = useSelector((state) => state.correccionesOrdenObservaciones);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <span style={{
        ...
        {correccionesObservaciones?.length > 0 && (
          <span style={{
      ...
      {loading ? (
      ...
      ) : (correccionesObservaciones?.length ?? 0) === 0 ? (
        <Empty
        ...
        >
          {correccionesObservaciones.map((obs, idx) => {
              ...
              <div
                ...
                style={{
                  ...
                  background: enEdicion
                    ? "#fffbe6"
                    : idx % 2 === 0 ? "#fff" : "#fafafa",
                  borderBottom: idx < (correccionesObservaciones?.length ?? 0) - 1 ? "1px solid #f0f0f0" : "none",
...
export default CorreccionObservacionesHistorial;