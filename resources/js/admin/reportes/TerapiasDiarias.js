                  ...
                  <div className="table-responsive">
                    ...
                    {status === 'succeeded' && (
                      <table aria-describedby="zero-config_info" className="table dt-table-hover tablas dataTable" id="zero-config" role="grid" style={{ width: '100%' }}>
                        ...
                        <tbody>
                          {terapiasDiarias.map((terapiaDiaria) => (
                            <tr key={terapiaDiaria.ID_PACIENTE}>
                              <td>
                                {
                                  terapiaDiaria.PACIENTE_NOMBRE.trim() + " " + terapiaDiaria.PACIENTE_APELLIDO.trim()
                                }
                              </td>
                              <td>{terapiaDiaria.PACIENTE_CEDULA}</td>
                              <td>{terapiaDiaria.SUCURSAL}</td>
                              <td>{terapiaDiaria.PACIENTE_CELULAR}</td>
                              <td>{terapiaDiaria.TIPO}</td>
                              <td>{terapiaDiaria.FECHA_ATENCION}</td>
                              <td>{terapiaDiaria.DOCTOR}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
...
export default TerapiasDiarias