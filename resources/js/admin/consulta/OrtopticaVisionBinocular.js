                                    ...
                                    <Select
                                      ...
                                      onChange={(value, val) => {
                                        if (!serviciosRealizados.find(servicio => servicio.value === value)) {
                                          ...
                                          setFieldValue('servicios_realizados_ortoptica_adultos', newServicios.map(s => s.value));
                                        }
                                      }}
                                    ...
                                    <Select
                                      ...
                                      onChange={(value, val) => {
                                        if (!proximosServicios.find(servicio => servicio.value == value)) {
                                          ...
                                          setFieldValue('servicios_proximos_ortoptica_adultos', newServicios.map(s => s.value));
                                        }
                                      }}
                                      options={servicios.map(servicio => ({
                                        value: servicio.id,
