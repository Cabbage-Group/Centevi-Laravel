                  ...
                  <div className="widget-header">
                    <div className="row">
                      <div className="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h3 className="text-center">Optometría Pediatrica</h3>
                      </div>
                    </div>
                  </div>
                      ...
                      {({ setFieldValue, isSubmitting }) => (
                        <Form method="post" role="form">
                          ...
                          <div className="form-row mb-4">
                            ...
                            <div className="form-group col-md-3">
                              <label htmlFor="tratamientos">Incubadora</label>
                              <Field
                                className="form-control"
                                id="incubadora"
                                name="incubadora"
                            ...
                            <div className="form-group col-md-3">
                              <label htmlFor="tratamientos">Tiempo</label>
                              <Field
                                className="form-control"
                                id="tiempo"
                                name="tiempo"
                            ...
                            <div className="form-group col-md-6">
                              <div className="table-responsive">
                                <table className="table table-bordered">
                                  <thead>
                                    <tr>
                                      <th className="text-center">AV/SC</th>
                                      <th>OD</th>
                                      <th>OI</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                      <td className="text-center">VL</td>
                                      <td>
                                        <Field
                                          className="form-control"
                                    ...
                                    <tr>
                                      <td className="text-center">VP</td>
                                      <td>
                                        <Field
                                          className="form-control"
                                    ...
                                    <tr>
                                      <td className="text-center">PH</td>
                                      <td>
                                        <Field
                                          className="form-control"
                            ...
                            <div className="form-group col-md-6">
                              <div className="table-responsive">
                                <table className="table table-bordered">
                                  <thead>
                                    <tr>
                                      <th className="text-center">AV/CC</th>
                                      <th>OD</th>
                                      <th>OI</th>
                                    </tr>
                                  </thead>
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-4">
                              <label htmlFor="VL">COVER TEST: VISION LEJANA:</label>
                              <Field
                                className="form-control"
                                id="VL"
                            ...
                            <div className="form-group col-md-4">
                              <label htmlFor="VP">VISION PROXIMA</label>
                              <Field
                                className="form-control"
                                id="VP"
                            ...
                            <div className="form-group col-md-4">
                              <label htmlFor="maddox">MADDOX:</label>
                              <Field
                                className="form-control"
                                id="maddox"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-6">
                              <label htmlFor="tratamientos">Seguimiento Visual(AO): </label>
                              <Field
                                className="form-control"
                                id="ao"
                            ...
                            <div className="form-group col-md-6">
                              <label htmlFor="tratamientos">Sacádicos(AO): </label>
                              <Field
                                className="form-control"
                                id="ao"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-2">
                              <label htmlFor="tratamientos">PPC: OR </label>
                              <Field
                                className="form-control"
                                id="or"
                            ...
                            <div className="form-group col-md-2">
                              <label htmlFor="tratamientos">L: </label>
                              <Field
                                className="form-control"
                                id="L"
                            ...
                            <div className="form-group col-md-2">
                              <label htmlFor="tratamientos">FR: </label>
                              <Field
                                className="form-control"
                                id="FR"
                            ...
                            <div className="form-group col-md-6">
                              <label htmlFor="tratamientos">Posicion compensatoria: </label>
                              <Field
                                className="form-control"
                                id="Posicion"
                          ...
                          <div className="table-responsive">
                            <table className="table table-bordered">
                              <thead>
                                <tr>
                                  <th className="text-center">PRUEBAS SENSORIALES</th>
                                  <th className="text-center">VISION LEJANA</th>
                                  <th className="text-center">VISION PROXIMA</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td className="text-center">Luces de Worth</td>
                                  <td>
                                    <Field
                                      className="form-control"
                                ...
                                <tr>
                                  <td className="text-center">Bagolinni</td>
                                  <td>
                                    <Field
                                      className="form-control"
                                      name="pruebas.vl_bg"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-3">
                              <h5 className="text-center">Estereopsis</h5>
                            </div>
                            <div className="form-group col-md-3">
                              <label htmlFor="inputAddress">Randot:</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                            ...
                            <div className="form-group col-md-3">
                              <label htmlFor="inputAddress">Lang:</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              <label htmlFor="inputAddress">Visión de Color</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-6">
                              <label htmlFor="inputAddress">TIPO DE LENTE</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                            ...
                            <div className="form-group col-md-2">
                              <label htmlFor="inputAddress">DPN</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                            ...
                            <div className="form-group col-md-2">
                              <label htmlFor="inputAddress">ALTURA</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                            ...
                            <div className="table-responsive">
                              <table className="table table-bordered">
                                <thead>
                                  <tr>
                                    <th>PARAMETROS</th>
                                    <th className="text-center">OJO DERECHO</th>
                                    <th className="text-center">OJO IZQUIERDO</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                    <td className="text-center">PODER</td>
                                    <td>
                                      <Field
                                        className="form-control"
                                  ...
                                  <tr>
                                    <td className="text-center">C.B</td>
                                    <td>
                                      <Field
                                        className="form-control"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-6">
                              <label htmlFor="inputAddress">Marca</label>
                              <Field
                                className="form-control"
                                id="inputAddress"
                          ...
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              <label htmlFor="inputAddress">CONDUCTA A SEGUIR: asdasda</label>
                              <Field
                                className="form-control textarea"
                                id="textarea"
                                // maxLength="800"
                          ...
                          <div className="form-row mb-12">
                            <div className="form-group col-md-6">
                              <label htmlFor="inputFehaProxCita">Fecha de proxima cita</label>
                              <Field
                                className="form-control"
