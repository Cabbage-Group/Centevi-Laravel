                                    ...
                                    <Select
                                      ...
                                      onChange={(value, val) => {
                                        if (!serviciosRealizados.find(servicio => servicio.value === value)) {
                                          ...
                                          setFieldValue('servicios_realizados_optometria_general', newServicios.map(s => s.value));
                                        }
                                      }}
                                    ...
                                    <Select
                                      ...
                                      onChange={(value, val) => {
                                        if (!proximosServicios.find(servicio => servicio.value == value)) {
                                          ...
                                          setFieldValue('servicios_proximos_optometria_general', newServicios.map(s => s.value));
                                        }
                                      }}
                                      options={servicios.map(servicio => ({
                                        value: servicio.id,
