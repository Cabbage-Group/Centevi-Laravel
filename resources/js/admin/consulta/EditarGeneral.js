                      ...
                      <nav aria-label="breadcrumb" className="breadcrumb-one">
                        <ol className="breadcrumb" style={{ background: '#0096881c' }}>
                          ...
                          <li aria-current="page" className="breadcrumb-item active">
                            <b>{ }</b>
                            {doctorActual === RefraccionGeneral.doctor ? " (mismo doctor)" : " (doctor diferente)"}
                          </li>
                        </ol>
                      </nav>
                      <nav
                                ...
                                onChange={(value, val) => {
                                  if (!serviciosRealizados.find(servicio => servicio.value == value)) {
                                    ...
                                    setFormData(prevState => ({
                                      ...prevState,
                                      servicios_realizados_optometria_general: newServicios.map(s => s.value)
                                    }));
                                  }
                                }}
                              ...
                              <Select
                                ...
                                onChange={(value, val) => {
                                  if (!proximosServicios.find(servicio => servicio.value == value)) {
                                    ...
                                    setFormData(prevState => ({
                                      ...prevState,
                                      servicios_proximos_optometria_general: newServicios.map(s => s.value)
                                    }));
                                  }
                                }}
                                options={servicios.map(servicio => ({
