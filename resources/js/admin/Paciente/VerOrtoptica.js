                    ...
                    >
                      ...
                      <div className="form-row mb-12">
                        ...
                        <div className="form-group col-md-6">
                          ...
                          >
                            {ortoptica && ortoptica.diagnosticos_ortoptica_adultos ? (
                              ortoptica.diagnosticos_ortoptica_adultos.map((diagnostico, index) => (
                                <div
                                  key={index}
                                  style={{
                                    color: 'black',
                        ...
                        <Col xxl={12} xl={12} md={12}>
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              ...
                              >
                                {ortoptica && ortoptica.servicios_realizados ? (
                                  ortoptica.servicios_realizados.map((servicio, index) => (
                                    <div
                                      key={index}
                                      style={{
                                        color: 'black',
                        ...
                        <Col xxl={12} xl={12} md={12}>
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              ...
                              >
                                {ortoptica && ortoptica.servicios_proximos ? (
                                  ortoptica.servicios_proximos.map((servicio, index) => (
                                    <div
                                      key={index}
                                      style={{
                                        color: 'black',
