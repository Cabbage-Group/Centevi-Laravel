  ...
  useEffect(() => {
    if (verPaciente) {
      setFormData({
        ...
        urgencia: verPaciente.urgencia
          ? typeof verPaciente.urgencia === 'string'
            ? typeof JSON.parse(verPaciente.urgencia) == 'string'
              ? JSON.parse(JSON.parse(verPaciente.urgencia))
              : JSON.parse(verPaciente.urgencia)
            : verPaciente.urgencia
          : {},
        menor: verPaciente.menor
          ? typeof verPaciente.menor === 'string'
            ? typeof JSON.parse(verPaciente.menor) == 'string'
              ? JSON.parse(JSON.parse(verPaciente.menor))
              : JSON.parse(verPaciente.menor)
            : verPaciente.menor
          : {},
      });
    }
