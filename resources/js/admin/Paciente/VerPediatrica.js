                        ...
                        <Col xxl={12} xl={12} md={12}>
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              ...
                              >
                                {pediatrica && pediatrica.servicios_realizados ? (
                                  pediatrica.servicios_realizados.map((servicio, index) => (
                                    <div
                                      key={index}
                                      style={{
                                        color: 'black',
                        ...
                        <Col xxl={12} xl={12} md={12}>
                          <div className="form-row mb-4">
                            <div className="form-group col-md-12">
                              ...
                              >
                                {pediatrica && pediatrica.servicios_proximos ? (
                                  pediatrica.servicios_proximos.map((servicio, index) => (
                                    <div
                                      key={index}
                                      style={{
                                        color: 'black',
