...
import { fetchUsuarios } from '../../redux/features/usuariosSlice.js';
...
const Usuarios = () => {
    ...
    useEffect(() => {
        dispatch(fetchUsuarios({ page: currentPage, limit: 6 }));
                                                        ...
                                                        <div className="row">
                                                            <div className="col-12 col-sm-6 d-flex justify-content-sm-start justify-content-center">
                                                                <div className="dataTables_length" id="zero-config_length">
                                                                    <label>
                                                                        Results :
                                                                        <select aria-controls="zero-config" className="form-control" name="zero-config_length">
                                                                            <option value="7">
                                                                                7
                                                                            </option>
                                                                            <option value="10">
                                                            ...
                                                            <tbody>
                                                                {usuarios.map((usuario) => (
                                                                    <tr key={usuario.id_usuario}>
                                                                        ...
                                                                        <td>
                                                                            <button
                                                                                className={`btn btn-${usuario.estado === 1 ? 'success' : 'danger'} btn-xs btnActivar`}
