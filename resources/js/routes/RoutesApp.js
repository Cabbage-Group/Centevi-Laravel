    ...
    <Router>
      <Routes>
        ...
        <Route>
          ...
          <Route
            path="/editar-bajaVision/:id/:id_consulta"
            element={<Sidebar component={<EditarBajaVision />} />}
          />
          <Route
            path="/ver-bajaVision/:id/:id_consulta"
          ...
          />
          <Route
            path="/editar-OptometriaGeneral/:id/:id_consulta"
            element={<Sidebar component={<EditarGeneral />} />}
          />
          <Route
          ...
          />
          <Route
            path="/ver-neonatos/:id/:id_consulta"
            element={<Sidebar component={<VerNeonatos />} />}
          />
          <Route
          ...
          />
          <Route
            path="/editar-pediatrica/:id/:id_consulta"
            element={<Sidebar component={<EditarPediatra />} />}
          />
          <Route
          ...
          />
          <Route
            path="/editar-ortoptica/:id/:id_consulta"
            element={<Sidebar component={<EditarOrtoptica />} />}
          />
          <Route
          ...
          <Route
            ...
            element={<Sidebar component={<Ordenes />} />}
          />
          <Route path="/create-orden" element={<Sidebar component={<CreateOrden />} />} />
          <Route
            path="/select-receta/:id_receta"
            element={<Sidebar component={<SelectReceta />} />}
          />
          <Route
            path="/editar-receta/:id_receta"
            element={<Sidebar component={<EditarReceta />} />}
          />
          <Route
          ...
          <Route
            path="/reportes-ultima-atencion"
            element={<Sidebar component={<UltimaAtencion />} />}
          />
          <Route
            path="/paciente-atendido-dia"
            element={<Sidebar component={<PacienteAtendidoDia />} />}
          />
          ...
          <Route
            ...
            element={<Sidebar component={<VerSesionTerapia />} />}
          />
          <Route
            path="/ver-sesion-terapia-pediatrica/:id_paciente/:id_terapia/:id_sesion"
            element={<Sidebar component={<VerSesionTerapiaPediatrica />} />}
          />
          <Route
            path="/ver-sesion-terapia-neonato/:id_paciente/:id_terapia/:id_sesion"
            element={<Sidebar component={<VerSesionTerapiaNeonato />} />}
          />
          <Route
          ...
          />
          <Route
            path="/editar-sesion-terapia-pediatrica/:id_paciente/:id_terapia/:id_sesion"
            element={<Sidebar component={<EditarSesionTerapiaPediatrica />} />}
          />
          <Route
            path="/editar-sesion-terapia-neonato/:id_paciente/:id_terapia/:id_sesion"
            element={<Sidebar component={<EditarSesionTerapiaNeonato />} />}
          />
          <Route
          ...
          />
          <Route
            path="/terapias-neonatos/:id/:id_terapia"
            element={<Sidebar component={<TerapiasNeonatos />} />}
          />
          <Route
            path="/terapias-ortoptica/:id/:id_terapia"
            element={<Sidebar component={<TerapiasOrtoptica />} />}
          />
          <Route
