...
export const deleteCita = createAsyncThunk("citasAgenda/deleteCita", async (id_cita) => {
  try {
...
export const updateCita = createAsyncThunk("citasAgenda/updateCita", async ({ id_cita, data }) => {
  try {
        ...
        if (action.payload.nueva_cita) {
          ...
          if (Array.isArray(state.currentType)) {
            if (
              ...
              state.currentType.includes(1) &&
              state.currentType.length === 2
            ) {
              ...
              state.currentType.includes(0) &&
              state.currentType.includes(1) &&
              state.currentType.includes(2) &&
              state.currentType.length === 3
            ) {
              if (tipo === "consulta" || tipo === "terapia" || tipo === "proxima_cita") {
                console.log(
                  `✅ Verificando si la cita de tipo ${tipo} y currentType es [0, 1, 2] ya existe`
                );
              ...
              if (tipo === "terapia" || tipo === "proxima_cita" || tipo === "consulta") {
                console.log(
                  `✅ Verificando si la cita de tipo ${tipo} y currentType es [1, 2] ya existe`
                );
              ...
              if (tipo === "terapia" || tipo === "proxima_cita" || tipo === "consulta") {
                console.log(
                  `✅ Verificando si la cita de tipo ${tipo} y currentType es [0, 2] ya existe`
                );
