...
export const fetchTiposAros = createAsyncThunk("tiposAros/fetchTiposAros", async ({ search }) => {
  try {
...
export const createTiposAros = createAsyncThunk("tiposAros/createTiposAros", async (values) => {
  try {
...
export const deleteTiposAros = createAsyncThunk("tiposAros/deleteTiposAros", async (id) => {
  try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deleteTiposAros.fulfilled, (state, action) => {
        ...
        state.tipo_aro_options_selecteds = state.tipo_aro_options_selecteds.filter(
          (tipoAro) => tipoAro.id !== action.payload
        );
      })
