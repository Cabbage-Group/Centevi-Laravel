  ...
  async ({ tabla, id_consulta, hubo_contacto }) => {
    try {
      const response = await axios.put(`${API}/actualizarcontacto`, {
        tabla,
        id_consulta: parseFloat(id_consulta.toString()),
        hubo_contacto,
...
export const actualizarNotaContacto = createAsyncThunk(
  'proximasCitas/actualizarNota',
  async ({ tabla, id_consulta, nota_contacto }) => {
    try {
      const response = await axios.put(`${API}/actualizarNota`, {
        tabla,
        id_consulta: parseFloat(id_consulta.toString()),
        nota_contacto,
        id_usuario: localStorage.getItem('id_usuario')
