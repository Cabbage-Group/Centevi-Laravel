...
export const createMateriales = createAsyncThunk("materiales/createMateriales", async (values) => {
  try {
...
export const deleteMateriales = createAsyncThunk("materiales/deleteMateriales", async (id) => {
  try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateMateriales.fulfilled, (state, action) => {
        state.status = "succeeded";
        const index = state.materiales.findIndex(
