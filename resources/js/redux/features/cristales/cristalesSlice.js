...
export const fetchCristales = createAsyncThunk("cristales/fetchCristales", async ({ search }) => {
  try {
...
export const createCristales = createAsyncThunk("cristales/createCristales", async (values) => {
  try {
...
export const deleteCristales = createAsyncThunk("cristales/deleteCristales", async (id_orden) => {
  try {
