...
class CreateTerapiaOptometriaNeonatosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terapia_optometria_neonatos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('terapia_optometria_neonatos');
    }
}
