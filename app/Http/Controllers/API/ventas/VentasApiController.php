...
class VentasApiController extends Controller
{
  public function guardarPagosReportes(Request $request)
  {
    ...
    foreach ($data as $item) {
      ReportePago::create([
        ...
        'cobro_anticipo_status' => $item['cobro_anticipo_status'] ?? null,
        ...
        'cobro_aplicado_status' => $item['cobro_aplicado_status'] ?? null,
  ...
  public function reportes(Request $request)
  {
    ...
    try {
      ...
      $query->where('cobro_anticipo_status', 'CLOSED');
